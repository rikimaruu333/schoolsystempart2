                        ...
                        ?>
                                <div class="student-card">
                                    ...
                                    <div class="buttons">
                                        ...
                                        <button class="update-student-button" id="updateStudentButton" onclick="openUpdateModal(<?= $row['student_id'] ?>)"><img src="../images/update.png" alt=""></button>

                                        <a href="deleteStudent.php?studentId=<?= $row['student_id'] ?>" onclick="return confirm('Are you sure you want to delete this student?');"><button class="delete-student-button"><img src="../images/delete_review.png" alt=""></button></a>
                                    </div>
                                </div>
                        <?php
                            }
